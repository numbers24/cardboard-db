...
/**
 * creates the dropdown for user collections
 * @param {*} user 
 * @returns 
 */
const createCollectionDropdown = (user) => {
	let add = new StringSelectMenuBuilder()
		.setCustomId('add')
...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addSubcommand(subcommand => 
			subcommand.setName('pokemon')
			.setDescription('lookup pokemon cards')
	...
	async execute(interaction) {
		...
		const add = createCollectionDropdown(user);
